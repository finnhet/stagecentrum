    ...
    <div class="card p-4 shadow-lg rounded mx-auto" style="max-width: 600px;">
      ...
      <form class="row g-3" action="{{ url('/vacancy_create') }}" method="POST">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" id="inputTitle" name="title" placeholder="Titel">
        </div>
        <div class="col-12">
          <label for="inputIntroduction" class="form-label">Introductie</label>
          <input type="text" class="form-control" id="inputIntroduction" name="introduction" placeholder="Introductie">
        </div>
        <div class="col-12">
          <label for="inputDescription" class="form-label">Beschrijving</label>
          <textarea class="form-control" id="inputDescription" name="description" rows="3" placeholder="Beschrijving"></textarea>
        </div>
        <div class="col-12">
          <label for="inputLocation" class="form-label">Locatie</label>
          <input type="text" class="form-control" id="inputLocation" name="location" placeholder="Locatie">
        </div>
