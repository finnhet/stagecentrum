    ...
    <x-app-layout>
        <div class="container mt-5">
            <div class="card p-4 shadow-lg rounded mx-auto" style="max-width: 600px;">
                ...
                <!-- New Form to Reload Page with Selected Werkveld -->
                <form method="GET" action="{{ url('/vacancy_create') }}">
                    <div class="col-12">
                        ...
                        <select class="form-control" id="fieldSelect" name="field_id" onchange="this.form.submit()">
                            <option value="" disabled {{ is_null($selectedFieldId) ? 'selected' : '' }}>Selecteer een werkveld</option>
            ...
            <form class="row g-3 mt-3" action="{{ url('/vacancy_create') }}" method="POST">
                ...
                <div class="card p-4 shadow-sm rounded mx-auto mt-3">
                    <h5 class="text-center">Selecteer Filters</h5>
                    <div class="row g-2">
                        @if(count($filters) > 0)
